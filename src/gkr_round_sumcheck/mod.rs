...
impl<F: Field> GKRRoundSumcheck<F> {
    ...
    pub fn prove<R: FeedableRNG>(
        ...
        // println!("Time to init phase 1: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        let mut phase1_ps = start_phase1_sumcheck(&h_g, f2);
        // println!("Time to start phase 1: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        ...
        // println!("Time to complete phase 1: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        let f1_gu = initialize_phase_two(&f1_g, &u);
        // println!("Time to init phase 2: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        let mut phase2_ps = start_phase2_sumcheck(&f1_gu, f3, f2.evaluate(&u));
        // println!("Time to start phase 2: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        ...
        // println!("Time to complete phase 2: {} microsec.", now.elapsed().as_micros() as u128);
        now = Instant::now();
        GKRProof {
