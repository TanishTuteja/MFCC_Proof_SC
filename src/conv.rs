...
//     pub fs_rng: &'a mut Blake2b512Rng,
...
#[derive(new)]
pub struct VerifierConv2D<'a, F: Field> {
...
//         let now = Instant::now();
//         println!("Inp vars {}", base_input_mle.num_vars());
//         println!("Pred vars {}", predicate_mle.num_vars());
//         println!("Rsigma vars {}", rsigma.len());
//         println!("Predicate Rand vars {}", predicate_initial_randomness.len());
...
impl<'a, F: Field + PrimeField> VerifierConv2D<'a,F> {
